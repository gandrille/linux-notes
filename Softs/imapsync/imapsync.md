Imap sync is just a single file perl script, but requires a couple of perl dependencies (see [Installation infos](https://imapsync.lamiral.info/INSTALL.d/INSTALL.Ubuntu.txt) )
